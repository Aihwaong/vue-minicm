<template>
    <div class="main">
        <div class="search-main">
            <div>
                <el-button type="primary" plain @click="addDialog()" size="small">新增停车场</el-button>
                <el-button
                    type="danger"
        ...
        <el-table class="table" :data="tableData" @selection-change="selectionChange" size="small">
            ...
            <el-table-column prop="areaName" label="停车场名称" width="100"></el-table-column>
        ...
        >
            ...
            >
                <el-form-item label="停车场名称" prop="areaName">
                    <el-input v-model="form.areaName" size="small"></el-input>
                </el-form-item>
                <el-form-item label="备注" prop="remark">
                    <el-input type="textarea" size="small" v-model="form.remark" maxlength="250" show-word-limit></el-input>
                </el-form-item>
...
export default {
    data() {
        return {
            REQUEST_URL: "/system/basic/parkingArea/",
            dialogVisible: false,
            keyword: "",
            form: {
                id: "",
