<template>
    <div class="main">
        ...
        <el-table class="table" :data="tableData" @selection-change="selectionChange" size="small">
            ...
            <el-table-column prop="chamberName" label="类型名称" width="100"></el-table-column>
        ...
        <el-dialog title="新增类型" :visible.sync="dialogVisible" @closed="dialogColosed" width="450px">
            ...
            >
                <el-form-item label="类型名称" prop="chamberName">
                    <el-input v-model="form.chamberName"></el-input>
                </el-form-item>
...
export default {
    data() {
        return {
            REQUEST_URL: "/system/basic/chamber/",
            dialogVisible: false,
            keyword: "",
            form: {
                id: "",
